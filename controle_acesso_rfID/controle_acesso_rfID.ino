...
String TagsCadastradas[] = {"eb96708b", 
                            "ID_2",
                            "ID_3"};
...
void loop() {  
  ler_ID();  //Chama a função responsável por fazer a leitura das Tag's
}
...
void ler_ID(){
        ...
        delay(1000); //aguarda  segundo para efetuar uma nova leitura
}
